...
public class SubmissionController {
    ...
    public ResponseEntity<SubmissionResponse> submitAssignment(
        ...
        var submission = submissionService.submitAssignment(assignmentId, submissionMapper.toDto(body));
    ...
    @PreAuthorize("hasRole('STUDENT')")
    public List<SubmissionResponse> getSubmittedByStudent() {
        return submissionMapper.toResponses(submissionService.getSubmittedByStudent());
    }
